...
lang.english = {
    ...
    ["save_config"] = "Configuration saved, and sent to all players!",
    ["show_possible_lang"] = "These are the list of all possible languages.",
    ["show_config"] = "These are the current config of unstuck, to edit them do {1}",
    ["invalid_setting"] = "The setting you are trying to edit does not exist!",
    ["use_cmd_word"] = "To edit this setting use {1} or {2}"
                
}
lang.turkish = {
    ["unstuck"] = "Sıkışmaktan kurtuldun!",
    ["cooldown"] = "Bu komutu tekrar kullanmadan önce %s saniye beklemelisin!",
    ["fail"] = "Sıkışıklığınızı çözemiyoruz, daha sonra tekrar deneyin veya bir yöneticiyle iletişime geçin!",
    ["no_perm"] = "Bu komutu kullanma izniniz yok!",
    ["save_config"] = "Yapılandırma kaydedildi ve tüm oyunculara gönderildi!",
    ["show_possible_lang"] = "Bu, tüm olası dillerin listesidir.",
    ["show_config"] = "Bu, sıkışmaktan kurtulma eklentisinin geçerli yapılandırmasıdır, bunları düzenlemek için {1} yapın",
    ["invalid_setting"] = "Düzenlemeye çalıştığınız ayar mevcut değil!",
    ["use_cmd_word"] = "Bu ayarı düzenlemek için {1} veya {2} kullanın"
}
